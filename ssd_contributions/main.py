...
# my local models
MODELZOO = {
	"llama2-7b": "/home/sophiaa/.cache/huggingface/hub/models--meta-llama--Llama-2-7b-chat-hf/snapshots/92011f62d7604e261f748ec0cfe6329f31193e33",
    "llama2-13b-chat-hf": "/home/sophiaa/.cache/huggingface/hub/models--meta-llama--Llama-2-13b-chat-hf",
    "llama2-70b": " /home/sophiaa/.cache/huggingface/hub/models--meta-llama--Llama-2-70b-chat-hf/snapshots/8b17e6f4e86be78cf54afd49ddb517d4e274c13f",
    "llama2-30b-hf": "/home/sophiaa/.cache/huggingface/hub/models--meta-llama--Llama-2-30b-hf",
}
...
def generate(input_text, approx_model_name, target_model_name, num_tokens=20, gamma = 4,
    ...
    tokenizer = AutoTokenizer.from_pretrained(approx_model_name, use_fast=True)

    small_model = AutoModelForCausalLM.from_pretrained(approx_model_name, torch_dtype=torch.float16).to(torch_device)
